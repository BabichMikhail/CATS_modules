...
#define VERSION "0.6.2-r1"
// there is buruduk3's small modification. Search “burunduk3”
...
#else
// VT100's escape sequences. Added by burunduk3, aren't in official version of testlib
    switch (color)
    {
      case LightGray: printf("\e[0m"); break;    
      case LightRed: printf("\e[1;31m"); break;    
      case LightCyan: printf("\e[1;36m"); break;    
      case LightGreen: printf("\e[1;32m"); break;    
      case LightYellow: printf("\e[1;33m"); break;    
      default:;
    }
#endif
}
